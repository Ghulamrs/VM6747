...
SHALIMAR_AS='C:\masm-tests\build\asm-win.exe' ./tests/remote-windows.sh
...
| Windows box | `ssh windows` | `ml64` and `link`, or the project's assembler through `SHALIMAR_AS`; `x86_64-windows` natively |
